...
const BODY = { experience: { allow_voice_interruption: true, microphone_auto_volume: true, character_id: 'bundled/seed', appearance_id: 'bundled/seed', voice_id: 'default', quality: 'auto' }, characters: [{ id: 'bundled/seed', display_name: 'Wren' }] }
...
it('uses the hosted player without starting a second local conversation', async () => {
  ...
  vi.stubGlobal('fetch', vi.fn(() => Promise.resolve({ ok: true, json: () => Promise.resolve({
    experience: { allow_voice_interruption: true, microphone_auto_volume: true, character_id: 'local/person', appearance_id: 'local/person', voice_id: 'default', quality: 'auto' },
