...
def _isolate_environment(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    for name in (
        "PERSONAE_SERVER_HOST",
        "PERSONAE_SERVER_PORT",
        "PERSONAE_LOG_LEVEL",
        "PERSONAE_STT_PROVIDER",
        "PERSONAE_ELEVENLABS_API_KEY",
        "PERSONAE_ELEVENLABS_STT_MODEL",
        "PERSONAE_ELEVENLABS_STT_LANGUAGE",
        "PERSONAE_ELEVENLABS_STT_SILENCE_SECONDS",
        "PERSONAE_ELEVENLABS_STT_FILTER_BACKGROUND_AUDIO",
